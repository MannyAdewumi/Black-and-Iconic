            ...
            <form>
                ...
                <div>
                    <button className='bg-obsedian text-white hover:bg-black font-bold py-2 px-6 
                     font-poppins rounded focus:outline-none'>Login</button>
                </div>
            </form>
            <p className='align-baseline font-montserrat font-medium mt-4 text-sm text-gray-500'>
                Don't have an account? Please <Link to="/register" className='text-obsedian 
                hover:text-black hover:font-bold'>Register</Link>
            </p>
            {/* Google sign in */}
            <div className='mt-6'>
                <button className='w-full flex flex-wrap gap-2 items-center justify-center 
